...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\n");
        printf("使用:./rinetd logfile inifile cmdport\n\n");
        printf("事例:./rinetd /tmp/rinetd.log /etc/rinetd.conf 5001\n\n");
        printf("        /DataSharingPlatform/tools/bin/procctl 5 /DataSharingPlatform/tools/bin/rinetd /tmp/rinetd.log /etc/rinetd.conf 5001\n\n");
