...
int main(int argc, char *argv[])
{
    if (argc < 3)
    {
        printf("使用:./procctl timetvl program argv ...\n");
        printf("事例:/DataSharingPlatform/tools/bin/procctl 10 /usr/bin/tar zcvf /tmp/tmp.tgz /usr/include\n");
        printf("事例:/DataSharingPlatform/tools/bin/procctl 60 /DataSharingPlatform/idc/bin/crtsurfdata /DataSharingPlatform/idc/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log csv,xml,json\n");
