// 本程序是通用的功能模块，用于把本地目录中的文件上传到远程的ftp服务器。
...
{
    printf("\n");
    printf("使用:/DataSharingPlatform/tools/bin/ftpputfiles logfilename xmlbuffer\n\n");

    printf("事例:/DataSharingPlatform/tools/bin/procctl 30 /DataSharingPlatform/tools/bin/ftpputfiles /log/idc/ftpputfiles_surfdata.log "
