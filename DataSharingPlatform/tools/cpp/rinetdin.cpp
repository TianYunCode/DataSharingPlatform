...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\n");
        printf("使用:./rinetdin logfile ip port\n\n");
        printf("事例:./rinetdin /tmp/rinetdin.log 192.168.150.128 5001\n\n");
        printf("        /DataSharingPlatform/tools/bin/procctl 5 /DataSharingPlatform/tools/bin/rinetdin /tmp/rinetdin.log 192.168.150.128 5001\n\n");
