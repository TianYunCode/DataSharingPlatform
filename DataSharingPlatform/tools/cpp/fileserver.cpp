...
int main(int argc, char *argv[])
{
    if (argc != 3)
    {
        printf("使用:./fileserver port logfile\n");
        printf("事例:./fileserver 5005 /log/idc/fileserver.log\n");
        printf("         /DataSharingPlatform/tools/bin/procctl 10 /DataSharingPlatform/tools/bin/fileserver 5005 /log/idc/fileserver.log\n\n\n");
        return -1;
    }
