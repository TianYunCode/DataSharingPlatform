...
int main(int argc, char *argv[])
{
    ...
    {
        // 如果参数非法，给出帮助文档。
        cout << "使用:./crtsurfdata inifile outpath logfile datafmt\n";
        cout << "例子:/DataSharingPlatform/tools/bin/procctl 60 /DataSharingPlatform/idc/bin/crtsurfdata /DataSharingPlatform/idc/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log csv,xml,json\n\n";
...
void crtsurfdata()
{
    ...
    // {
    //     logfile.write("%s,%s,% .1f,%.1f,%d,%d,%.1f,%.1f,%.1f\n", a.obtid, aa.ddatetime, aa.t / 10.0, aa.p / 10.0, aa.u, aa.wd, aa.wf / 10.0, aa.r / 10.0, aa.vis / 10.0);
    // }
}
