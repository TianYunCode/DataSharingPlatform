// 本程序是守护程序，检查共享内存中进程的心跳，如果超时，则终止进程。
...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\n");
        printf("使用:./checkproc logfilename\n");

        printf("事例:/DataSharingPlatform/tools/bin/procctl 10 /DataSharingPlatform/tools/bin/checkproc /tmp/log/checkproc.log\n\n");
