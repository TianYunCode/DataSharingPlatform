...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\n");
        printf("使用:./obtmindtodb pathname connstr charset logfile\n");

        printf("事例:/DataSharingPlatform/tools/bin/procctl 10 /DataSharingPlatform/idc/bin/obtmindtodb /idcdata/surfdata "
