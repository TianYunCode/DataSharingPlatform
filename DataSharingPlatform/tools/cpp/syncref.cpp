...
void _help()
{
    printf("使用:/DataSharingPlatform/tools/bin/syncref logfilename xmlbuffer\n\n");

    printf("不分批同步，把T_ZHOBTCODE1@db128同步到T_ZHOBTCODE2。\n");
    printf("事例:/DataSharingPlatform/tools/bin/procctl 10 /DataSharingPlatform/tools/bin/syncref /log/idc/syncref_ZHOBTCODE2.log "
    ...
    printf("       /DataSharingPlatform/tools/bin/procctl 10 /DataSharingPlatform/tools/bin/syncref /log/idc/syncref_ZHOBTCODE3.log "
           "\"<localconnstr>idc/idcpwd@snorcl11g_128</localconnstr><charset>Simplified Chinese_China.AL32UTF8</charset>"
    ...
    printf("       /DataSharingPlatform/tools/bin/procctl 10 /DataSharingPlatform/tools/bin/syncref /log/idc/syncref_ZHOBTMIND2.log "
           "\"<localconnstr>idc/idcpwd@snorcl11g_128</localconnstr><charset>Simplified Chinese_China.AL32UTF8</charset>"
...
bool _syncref()
{
    ...
    // insert into T_ZHOBTCODE2(stid,cityname,provname,lat,lon,height,upttime,recid) select obtid,cityname,provname,lat,lon,height,upttime,keyid from T_ZHOBTCODE1@db128 where obtid like '57%';
    if (starg.synctype == 1)
    {
    ...
    // insert into T_ZHOBTCODE3(stid,cityname,provname,lat,lon,height,upttime,recid) select obtid,cityname,provname,lat,lon,height,upttime,keyid from T_ZHOBTCODE1@db128 where obtid in (:1,:2,:3,...,:starg.maxcount);
