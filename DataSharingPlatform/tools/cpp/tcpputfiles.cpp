...
{
    printf("\n");
    printf("使用:/DataSharingPlatform/tools/bin/tcpputfiles logfilename xmlbuffer\n\n");

    printf("事例:/DataSharingPlatform/tools/bin/procctl 20 /DataSharingPlatform/tools/bin/tcpputfiles /log/idc/tcpputfiles_surfdata.log "
    ...
    printf("andchild      是否上传clientpath目录下各级子目录的文件，true-是；false-否，默认为false。\n");
