...
namespace wty
{
    ...
    bool cftpclient::get(const string &remotefilename, const string &localfilename, const bool bcheckmtime)
    {
        ...
        // 改为正式的文件。
        if (rename(strlocalfilenametmp.c_str(), localfilename.c_str()) != 0)
        {
            return false;
        }
    ...
    bool cftpclient::size(const string &remotefilename)
    {
        ...
        if (FtpSize(remotefilename.c_str(), &m_size, FTPLIB_IMAGE, m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::chdir(const string &remotedir)
    {
        ...
        if (FtpChdir(remotedir.c_str(), m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::mkdir(const string &remotedir)
    {
        ...
        if (FtpMkdir(remotedir.c_str(), m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::rmdir(const string &remotedir)
    {
        ...
        if (FtpRmdir(remotedir.c_str(), m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::nlist(const string &remotedir, const string &listfilename)
    {
        ...
        if (FtpNlst(listfilename.c_str(), remotedir.c_str(), m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::put(const string &localfilename, const string &remotefilename, const bool bchecksize)
    {
        ...
        // 发送文件。
        if (FtpPut(localfilename.c_str(), strremotefilenametmp.c_str(), FTPLIB_IMAGE, m_ftpconn) == false)
        {
            return false;
        }
        ...
        // 重命名文件。
        if (FtpRename(strremotefilenametmp.c_str(), remotefilename.c_str(), m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::ftpdelete(const string &remotefilename)
    {
        ...
        if (FtpDelete(remotefilename.c_str(), m_ftpconn) == false)
        {
            return false;
        }
    ...
    bool cftpclient::site(const string &command)
    {
        ...
        if (FtpSite(command.c_str(), m_ftpconn) == false)
        {
            return false;
        }
