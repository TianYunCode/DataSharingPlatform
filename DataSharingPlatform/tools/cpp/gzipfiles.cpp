...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\n");
        printf("使用:/DataSharingPlatform/tools/bin/gzipfiles pathname matchstr timeout\n\n");
        printf("事例:/DataSharingPlatform/tools/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n");
        cout << R"(        /DataSharingPlatform/tools/bin/gzipfiles /log/idc "*.log.20*" 0.02)" << endl;
        printf("        /DataSharingPlatform/tools/bin/procctl 300 /DataSharingPlatform/tools/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
        printf("        /DataSharingPlatform/tools/bin/procctl 300 /DataSharingPlatform/tools/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n\n");
